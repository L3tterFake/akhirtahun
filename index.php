...
<body>
  ...
  <div class="overlay">
	   ...
	   <div class="awalan">
	     ...
	     <label style="font-size:16px">Akhir Tahun</label>
	   </div>
	</div>
  </div>
  ...
  <div class="wrapper semihidden" id="wrapper">
    ...
    <div class="letter" id="letter">
      <p><b>Halooo Sayangg... 🫠</b><br>... ... ... ... ... ...<br>... ... ... ... ... ... ...</p>
    </div>
  </div>
  <h3 class="title semihidden">Buka <span style="color:pink">surat</span> ini yaa 🫶</h3>
  
  <div class="container" id="container">
    <p class="titleC"><b>Haloooo <span style="color:pink">Sayangg</span> 🫣🫶</b></p>
    <p class="messageC"></p>
  </div>
...
function createHearts() {
    ...
    function katanimasiAlts(){
		...
		"Sebelum tahun 2024 ini berakhir, aku mau bilang makasihhh banget udah jadi part yang paling indah buat aku, kamu yang selalu ada buat aku, selalu nemenin hari hari aku, makasihh jugaa udah jadi rumah yang paling nyaman yang pernah aku tempati.",
                    ...
                    "<br>MAKASIH YA SAYANGKUUU, MANISKUU, DUNIAKU, SEMESTAKUU, IMUTT KUU, PUNYAKUUUU... 🥳",
                    "<br><b id='teksLove' style='background:#fff;border-radius:12px;padding:4px 5px;text-shadow:none;color:red'>LOVEE YOUUUU SAYANGKUU 🫣❤️‍🔥🤍</b>",
				 ],
        startDelay: 1,
        speed: 26,
        cursor: true,
